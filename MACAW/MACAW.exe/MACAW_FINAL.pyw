...
def janela_login():
    janelas.theme('Green')
    layout = [
        [janelas.Image(r"Images\logo_macaw-removebg-preview.png", s = (None,None), pad = (150, None))],
    ...
    return  janelas.Window('Tela de Login', layout, icon =r'Images\icon_logo.ico',  size = (500, 600), finalize= True )
...
def janela_escolha():
    ...
    return janelas.Window('Escolha', layout=layout, finalize=True,icon =r'Images\icon_logo.ico', size = (500, 600)) #Chamando a janela
...
def janela_cadastro_aluno():
    ...
    return janelas.Window('Cadastro de aluno', layout=layout,  finalize=True,icon =r'Images\icon_logo.ico', size = (500, 600))  
...
def janela_cadastro_funcionarios():
    ...
    return janelas.Window('Cadastro de funcionarios', layout=layout,  finalize=True,icon =r'Images\icon_logo.ico', size = (500, 600))  
...
def janela_cadastro_disciplina():
    ...
    return janelas.Window('Cadastro de diciplinas', layout=layout,  finalize=True,icon =r'Images\icon_logo.ico', size = (500, 600))  
...
def janela_cadastro_curso():
    ...
    return janelas.Window('Cadastro de curso', layout=layout,  finalize=True,icon =r'Images\icon_logo.ico', size = (500, 600))  
...
def janela_cadastro_turno():
    ...
    return janelas.Window('Cadastro de turno', layout=layout,  finalize=True,icon =r'Images\icon_logo.ico', size = (500, 600))  
...
def janela_cadastro_matricula(): 
    ...
    return janelas.Window('Matricula', layout=layout,  finalize=True,icon =r'Images\icon_logo.ico', size = (500, 600)) 
...
while True: # lupe infinito
    ...
    if window == janelaLogin and event == 'Entrar':
        ...
        if verificacao_campo_funcionarios == 'EMAIL' or verificacao_campo_funcionarios == 'CPF':
            ...
            janelas.popup('Você digitou um usuario ou senha inválido, tente novamente.')
    ...
    # Quando queremos fechar janelas;
    ...
    if window == janelaCadAluno and event == "Salvar":
        ...
        janelas.popup('Cadastrado de Aluno realizada com sucesso!')
    ...
    if window == janelaCadFuncionario and event == "Salvar":
        ...
        janelas.popup('Cadastrado de Funcionario realizada com sucesso!')
